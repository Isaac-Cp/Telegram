...
async def collect_group_metadata(client, group: Group):
    ...
    try:
        ...
        # STEP 1: Participants Count Check (Reject if < 200 - Master Prompt Step 5)
        ...
        permissions = full_channel.full_chat.default_banned_rights
