...
class Lead(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    def original_message(self, value: str) -> None:
    ...
    def telegram_user_id(self) -> int | None:
        return self.user.telegram_user_id if self.user else None

    @property
    def ltv_score_record(self):
        return self.user.ltv_score_record if self.user else None
